                ...
                <div class="content">
                    ...
                    <div class="price-body">
                        ...
                        <?php foreach ( $settings['features_repeater'] as $index => $item ) : 
							...
							$plan4_is_SVG = 'svg' === $item['plan4_selected_icon']['library'];
							$plan5_is_SVG = 'svg' === $item['plan4_selected_icon']['library'];
							$plan6_is_SVG = 'svg' === $item['plan6_selected_icon']['library'];
                            ?>
